...
from vitg.network.backbone.vitgyolov8.yolo.utils.ops import segments2boxes
...
def check_cls_dataset(dataset: str):
    ...
    if not data_dir.is_dir():
        ...
        if dataset == "imagenet":
            ...
            url = f"https://github.com/vitg.vitgyolov8/yolov5/releases/download/v1.0/{dataset}.zip"
