...
class YOLODataset(BaseDataset):
    ...
    def cache_labels(self, path=Path("./labels.cache")):
        ...
        if is_dir_writeable(path.parent):
            ...
            LOGGER.warning(
                f"{self.prefix}WARNING ⚠️ Cache directory {path.parent} is not writeable"
            )  # not writeable
        return x

    def get_labels(self):
        print("get sample labels")
    ...
    def collate_fn(batch):
        ...
        # print("check label shape bbox")
        # print(new_batch["bboxes"].shape)
        # print(new_batch["bboxes"])
        return new_batch
