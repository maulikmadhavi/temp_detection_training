...
from vitg.network.backbone.vitgyolov8.yolo.utils.torch_utils import profile
...
def autobatch(model, imgsz=640, fraction=0.7, batch_size=16):
    ...
    # Usage:
    #     import torch
    #     from vitg.utils.autobatch import autobatch
    #     model = torch.hub.load('vitg.vitgyolov8/yolov5', 'yolov5s', autoshape=False)
