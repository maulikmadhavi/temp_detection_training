...
from vitg.network.backbone.vitgyolov8.yolo.utils import threaded
...
class Colors:
    # vitg.vitgyolov8 color palette https://vitg.vitgyolov8.com/
    def __init__(self):
...
colors = Colors()  # create instance for 'from vitg.utils.plots import colors'
...
def save_one_box(
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/vitg.vitgyolov8/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False):
    # Plot training results.csv. Usage: from vitg.utils.plots import *; plot_results('path/to/results.csv')
