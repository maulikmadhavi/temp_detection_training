...
from vitg.network.backbone.vitgyolov8.yolo.utils import LOGGER

GITHUB_ASSET_NAMES = (
    [
        f"yolov8{size}{suffix}.pt"
        for size in "nsmlx"
...
def attempt_download_asset(file, repo="vitg.vitgyolov8/assets", release="v0.0.0"):
    # Attempt file download from GitHub release assets if not found locally. release = 'latest', 'v6.2', etc.
    from vitg.network.backbone.vitgyolov8.yolo.utils import SETTINGS
