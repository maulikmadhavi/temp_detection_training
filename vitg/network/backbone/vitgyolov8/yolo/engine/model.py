...
from vitg.network.backbone.vitgyolov8.yolo.utils.downloads import GITHUB_ASSET_STEMS
from vitg.network.backbone.vitgyolov8.yolo.utils.torch_utils import smart_inference_mode
