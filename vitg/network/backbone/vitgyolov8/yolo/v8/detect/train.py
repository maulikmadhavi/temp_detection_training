...
from vitg.network.backbone.vitgyolov8.yolo.engine.trainer import BaseTrainer
from vitg.network.backbone.vitgyolov8.yolo.utils import DEFAULT_CFG, RANK, colorstr
...
from vitg.network.backbone.vitgyolov8.yolo.utils.plotting import (
    plot_images,
    plot_results,
)
...
class Loss:
    ...
    def bbox_decode(self, anchor_points, pred_dist):
        if self.use_dfl:
            ...
            # print("self.proj.type(pred_dist.dtype)")
            # print(self.proj.type(pred_dist.dtype))
            # print(matmul(self.proj.type(pred_dist.dtype)))
    ...
    def __call__(self, preds, batch):
        ...
        print("pred_distri and pred_scores shape")
        ...
        print("after strid archor shape")
