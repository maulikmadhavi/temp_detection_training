...
from vitg.network.backbone.vitgyolov8.yolo.engine.validator import BaseValidator
from vitg.network.backbone.vitgyolov8.yolo.utils import DEFAULT_CFG, colorstr, ops
from vitg.network.backbone.vitgyolov8.yolo.utils.checks import check_requirements
from vitg.network.backbone.vitgyolov8.yolo.utils.metrics import (
    ConfusionMatrix,
    DetMetrics,
    box_iou,
)
...
class DetectionValidator(BaseValidator):
    def __init__(
        self, dataloader=None, save_dir=None, pbar=None, logger=None, args=None
    ):
