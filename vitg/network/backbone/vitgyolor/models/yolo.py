...
from vitg.network.backbone.vitgyolor.models.common import (
    DNL,
    DWT,
    GC,
    NMS,
...
from vitg.network.backbone.vitgyolor.models.experimental import C3, CrossConv, MixConv2d
from vitg.network.backbone.vitgyolor.utils.autoanchor import check_anchor_order
from vitg.network.backbone.vitgyolor.utils.general import (
    check_file,
    make_divisible,
    set_logging,
)
from vitg.network.backbone.vitgyolor.utils.torch_utils import (
    copy_attr,
    fuse_conv_and_bn,
    initialize_weights,
    model_info,
...
class IDetect(nn.Module):
    ...
    def forward(self, x):
        ...
        return tuple(x) if self.training else (torch.cat(z, 1), x)
...
class Model(nn.Module):
    def __init__(
        self, cfg="yolov5s.yaml", ch=3, nc=None, nid=None
