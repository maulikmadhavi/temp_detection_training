...
def img2label_paths(img_paths):
    ...
    # sa, sb = os.sep + 'images' + os.sep, os.sep + 'labels' + os.sep  # /images/, /labels/ substrings
    return [
        "/home/alex/data/coco/dell1_val_data/annotations/yolo_anno_alltrainval_0_81_livsbox80plas81_clearcrowdimg_withblending/"
        ...
        if self.augment:
            ...
            if random.random() < hyp["paste_in"]:
                ...
                while len(sample_labels) < 30:
                    ...
                    # print("select labels")
                    # print(random.randint(0, len(self.labels) - 1))
...
def copy_paste(img, labels, segments, probability=0.5):
    # print("run with copy past function")
    ...
    if probability and n:
        ...
        print("run with copy past image")
        cv2.imwrite(
            "/home/alex/project/people_counting_people_detection/yolov7/yolov7-update/yolov7/sample_plot/debug.jpg",
            img,
        )  # debug
...
def pastein(image, labels, sample_labels, sample_images, sample_masks):
    ...
    for s in scales:
        ...
        if (
            len(sample_labels) and (xmax > xmin + 20) and (ymax > ymin + 20)
        ):  # allow 30% obscuration of existing labels
            print("activate pasin")
...
def extract_boxes(
    path="../coco/",
):  # from vitg.utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path="../coco", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from vitg.utils.datasets import *; autosplit('../coco')
    Arguments
