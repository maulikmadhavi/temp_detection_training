...
from vitg.network.backbone.vitgyolov7.models.common import *

from vitg.network.backbone.vitgyolov7.models.experimental import *
from vitg.network.backbone.vitgyolov7.utils.autoanchor import check_anchor_order
from vitg.network.backbone.vitgyolov7.utils.general import (
    check_file,
    make_divisible,
    set_logging,
)
from vitg.network.backbone.vitgyolov7.utils.loss import SigmoidBin
...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if self.traced and isinstance(m, (Detect, IDetect, IAuxDetect, IKeypoint)):
                break
