...
from vitg.network.backbone.vitgyolov7.utils.datasets import letterbox
...
# from vitg.utils.general import non_max_suppression, make_divisible, scale_coords, xyxy2xywh
# from vitg.network.backbone.vitgyolov7.utils.plots import color_list, plot_one_box
from vitg.network.backbone.vitgyolov7.utils.torch_utils import time_synchronized
...
class DownC(nn.Module):
    ...
    def forward(self, x):
        # print("cat shape")
        # print(self.cv2(self.cv1(x)).shape)
        # print(self.cv3(self.mp(x)).shape)
