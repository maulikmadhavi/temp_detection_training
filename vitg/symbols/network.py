from vitg.utils import torch_utils

# from vitg.utils.google_utils import *
from vitg.utils.layers import *
from vitg.utils.parse_config import *
...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, nc, img_size=(416, 416), verbose=False):
        ...
        None if ONNX_EXPORT else self.info(verbose)  # print model description
